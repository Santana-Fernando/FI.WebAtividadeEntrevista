    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/clientes").Include(
                      "~/Scripts/Clientes/FI.Clientes.js", "~/Scripts/Clientes/FI.Beneficiario.js", "~/Scripts/Clientes/FI.CepApi.js"));
            ...
            bundles.Add(new ScriptBundle("~/bundles/altClientes").Include(
                       "~/Scripts/Clientes/FI.Beneficiario.js", "~/Scripts/Clientes/FI.AltClientes.js", "~/Scripts/Clientes/FI.CepApi.js"));
