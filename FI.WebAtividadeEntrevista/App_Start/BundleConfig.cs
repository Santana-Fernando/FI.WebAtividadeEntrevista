    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/clientes").Include(
                      "~/Scripts/Clientes/FI.Clientes.js", "~/Scripts/Beneficiarios/FI.Beneficiario.js", "~/Scripts/CepApi/FI.CepApi.js"));
            ...
            bundles.Add(new ScriptBundle("~/bundles/altClientes").Include(
                       "~/Scripts/Beneficiarios/FI.Beneficiario.js", "~/Scripts/Clientes/FI.AltClientes.js", "~/Scripts/CepApi/FI.CepApi.js"));
